    ...
    <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
        <div class="card testimonial-card">
            ...
            <div class="avatar mx-auto white">
				<img src="<?php echo base_url('assets/Images/img9.png'); ?>" class="rounded-circle" alt="icon">
            </div>
            
            <div class="card-body">
                <h4 class="card-title">Liste des tickets à réviser</h4>
                <hr>

                <div class="table-responsive text-nowrap">
                    <table class="table table-sm table-striped" id="tb_revise">
                        <thead>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($session != 3){
                                        ...
                                        <a href="<?php echo base_url('Ticket/traitement/' . $row->id . '/Reviser'); ?>" class="btn-floating btn-sm btn-info" data-tooltip="tooltip" data-placement="bottom" title="Consulter"><i class="fas fa-eye"></i></a>
                                        <?php } else { ?>
                                        <a href="<?php echo base_url('Ticket/traitement/' . $row->id . '/Reviser'); ?>" class="btn-floating btn-sm btn-success" data-tooltip="tooltip" data-placement="bottom" title="Réviser"><i class="fas fa-edit"></i></a>
                                        <?php }
                                    } ?>
                                </td>
                            </tr>
