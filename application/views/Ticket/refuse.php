<div class="row wow">
    <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
        <div class="card testimonial-card">
            ...
            <div class="card-body">
                <h4 class="card-title">Liste des tickets Refusés</h4>
                <hr>

                <div class="table-responsive text-nowrap">
                    <table class="table table-sm table-striped" id="tb_refus">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo date('d/m/Y, H:i', strtotime($row->dateRefus)); ?></td>
                                <td><?php echo date('d/m/Y, H:i', strtotime($row->dateDemande)); ?></td>
                                <td>
                                    <a href="" class="btn-floating btn-sm btn-info" data-toggle="modal" data-target="#modalAfficher" data-keyboard="false" data-backdrop="static" data-id="<?php echo $row->id; ?>" data-numTicket="<?php echo $row->numTicket; ?>" data-tooltip="tooltip" data-placement="bottom" title="Visualiser"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
...
<!-- Modal Afficher -->
<div class="modal fade" id="modalAfficher" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	 aria-hidden="true">
	<div class="modal-dialog cascading-modal modal-avatar modal-xl" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<img src="<?php echo base_url('assets/Images/img4.png') ?>" alt="icon"
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#modalAfficher').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                url: '<?php echo base_url('ticket/Visualiser/') ?>' + idTicket + '/refuse',
                type: 'GET',
                dataType: 'json',
